...
const StoryEditModal = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex w-full flex-col items-center justify-start gap-[22px]">
          <div className="relative flex h-[600px] w-[500px] items-center justify-center  rounded-[22px] bg-slate-100">
            {image && (
              <Image
                src={image}
                width={500}
                height={600}
                alt="User"
                className="h-[600px] w-[500px]   rounded-[22px] bg-cover bg-center"
              />
            )}
          </div>
          <div
            ...
            className="mx-auto flex w-full cursor-pointer items-center justify-center gap-6"
          >
            <svg
              width="26"
              height="31"
