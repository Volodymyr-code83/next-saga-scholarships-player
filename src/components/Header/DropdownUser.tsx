...
import LogoutAlert from "../common/Modals/LogoutAlert";
    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs">Player</span>
        </span>
        ...
        <span className="h-12 w-12 rounded-full">
          <Image
            ...
            style={{
                width: "48px", // Set the width to match the specified width
                height: "48px", // Set the height to match the specified height
