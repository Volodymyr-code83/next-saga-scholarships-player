  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onFormSubmit)}>
        <div className="mt-[30px] flex w-full flex-col items-center justify-start gap-11">
          <div className="flex w-full flex-col items-start justify-start gap-4">
            <div className="relative flex h-full max-h-[597px] w-full max-w-[1230px] flex-col items-start justify-start gap-4 rounded-[20px] ">
              <textarea
                {...register("textInput")}
                rows={5}
